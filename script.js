...
function ex14(){
    pessoas = []
function ex14(){
    // construindo o objeto "pessoa" e inserindo na lista
    p = {
    ...
    // montar uma tabela com as informações das pessoas
...
function ex15(){
     ...
     usuario = document.getElementById("ex15-escolha").value;
    ...
    document.getElementById("ex15-saida").innerHTML =
        `Você escolheu <b>${usuario}</b>.<br>` +
        `Computador escolheu <b>${computador}</b>.<br>` +
        `<b>${resultado}</b>`;
}
